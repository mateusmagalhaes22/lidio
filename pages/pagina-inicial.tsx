...
Temos modelos com medidas padrão e também fazemos sob medida, do jeitinho que você precisa.
Encomende direto pelo site e receba um atendimento rápido e sem complicação!</p>
    </div>
  );
}
